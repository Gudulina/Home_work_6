...
public class Parsing {
    public HashMap<String, Object> parsingUserInput() {
        ...
        if (fullName.length == 3) {
            userInfo.put("lastName", fullName[0]);
            userInfo.put("firstName", fullName[1]);
            userInfo.put("patronymic", fullName[2]);
        }
        return userInfo;
    }
}
